layui.define(['jsHelper','jsTree','layer'], function (exports) {
    var js = layui.jsHelper,
        $ = js.$,
        layer = layui.layer;
   
    var cbiconpath = layui.cache.base + "lp/jsSelect/images/";

    if (typeof ($.jsSelect) == undefined || $.jsSelect == null) {
        layui.link(layui.cache.base + 'lp/jsSelect/jsSelect.css');
        //lrselect
        (function (a, b) {
            a(function () {
                    ...
                    for (var f = 0, h = e.data.length; f < h; f++) {
                        ...
                        if (!g._lrhide) {
                            if (!!e.multipleMapValue && e.multipleMapValue[f] != undefined) {
                                var c = a('<li data-value="' + f + '" class="lr-selectitem-li" ><img class="lr-select-node-cb" src="'+cbiconpath+'checkbox_1.png">' + g[e.text] + "</li>");
                                d.append(c)
                            } else {
                                var c = a('<li data-value="' + f + '" class="lr-selectitem-li" ><img class="lr-select-node-cb" src="'+cbiconpath+'checkbox_0.png">' + g[e.text] + "</li>");
                                d.append(c)
                            }
                        }
                    }
                    ...
                    if (j.type != "multiple") {
                        ...
                        if (d.hasClass("lr-selectitem-li") || d.hasClass("lr-select-node-cb")) {
                            ...
                            if (i == -1) {
                                ...
                                j.multipleValue = [];
                                j.multipleText = [];
                                g.find('.lr-select-node-cb[src$="checkbox_1.png"]').attr("src", cbiconpath+'checkbox_0.png');
                                g.slideUp(150);
                                h.removeClass("lr-select-focus")
                            } else {
                                var m = true;
                                if (j.multipleMapValue[i] == undefined) {
                                    ...
                                    c.attr("src", cbiconpath+"checkbox_1.png")
                                } else {
                                    j.multipleValue = [];
                                    j.multipleText = [];
                                    ...
                                    m = false;
                                    c.attr("src", cbiconpath+"checkbox_0.png")
                                }
                                h.trigger("change");
                                if (j.select) {
            ...
            a.fn.lrselect = function (e) {
                ...
                if (d.url) {
                    b.http.httpAsync(d.method, d.url, d.param, function (f) {
                        ...
                        if (m.isload == true) {
                            ...
                            switch (m.type) {
                                ...
                                case "multiple":
                                    ...
                                    m.multipleText = [];
                                    if (m.isrender) {
                                        c.find('.lr-select-node-cb[src$="checkbox_1.png"]').attr("src", cbiconpath+"checkbox_0.png")
                                    }
                                    var k = f.split(",");
                                    for (var n = 0, o = m.data.length; n < o; n++) {
                                        ...
                                        if (h != -1) {
                                            ...
                                            if (m.isrender) {
                                                c.find('[data-value="' + n + '"] .lr-select-node-cb').attr("src", cbiconpath+"checkbox_1.png")
                                            }
                                            if (m.select) {
