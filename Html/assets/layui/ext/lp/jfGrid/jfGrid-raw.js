...
(function (a, j) {
    ...
    var h = top.$.rootUrl + "assets/Content/images/jfgrid/";
    ...
    var c = {
        ...
        layout: function (t, v) {
            ...
            t.find("#jfgrid_body_" + v.id).append('<div class="jfgrid-nodata-img" id="jfgrid_nodata_img_' + v.id + '"  ><img src="' + top.$.rootUrl + 'assets/Content/images/jfgrid/nodata.jpg"></div>');
            if (v.isPage) {
                t.css({
                    "padding-bottom": "35px"
                });
        ...
        reload: function (n, o) {
            ...
            if (o.isPage) {
                ...
                j.httpAsync("GET", o.url, o.param, function (p) {
                    j.loading(false);
                    if (p) {
                        o.rowdatas = p.rows;
