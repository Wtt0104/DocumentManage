...
namespace Toolkits.Web
{
    ...
    public class RequestHelper
    {
        ...
        /// <summary>
        /// 将请求消息中的参数抽取装入字典
        /// author:xsq at 2018.6.3
        ///
        /// </summary>
        /// <param name="request"></param>
        /// <returns></returns>
        public static Dictionary<string, string> GetFormToList(HttpRequestMessage request)
        {
            Dictionary<string, string> dict = new Dictionary<string, string>();
            var list = (KeyValuePair<string, string>[])request.Properties.FirstOrDefault(o => o.Key == "MS_QueryNameValuePairs").Value;
        ...
        public static string GetQueryString(string strName, bool sqlSafeCheck)
        {
            ...
            if (sqlSafeCheck && !StringExt.StringCheck.IsSafeSqlString(HttpContext.Current.Request.QueryString[strName]))
        ...
        public static string GetFormString(string strName, bool sqlSafeCheck)
        {
            ...
            if (sqlSafeCheck && !StringExt.StringCheck.IsSafeSqlString(HttpContext.Current.Request.Form[strName]))
                return "unsafe string";
        ...
        {
            return ConvertExt.ConvertHelper.StrToInt(HttpContext.Current.Request.QueryString[strName], 0);
        }
        ...
        {
            return ConvertExt.ConvertHelper.StrToInt(HttpContext.Current.Request.QueryString[strName], defValue);
        }
        ...
        {
            return ConvertExt.ConvertHelper.StrToInt(HttpContext.Current.Request.Form[strName], defValue);
        }
        ...
        {
            return ConvertExt.ConvertHelper.StrToDecimal(HttpContext.Current.Request.QueryString[strName], defValue);
        }
        ...
        {
            return ConvertExt.ConvertHelper.StrToDecimal(HttpContext.Current.Request.Form[strName], defValue);
        }
        ...
        {
            return ConvertExt.ConvertHelper.StrToFloat(HttpContext.Current.Request.QueryString[strName], defValue);
        }
        ...
        {
            return ConvertExt.ConvertHelper.StrToFloat(HttpContext.Current.Request.Form[strName], defValue);
        }
