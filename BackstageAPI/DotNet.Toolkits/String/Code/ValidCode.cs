...
namespace Toolkits.StringExt
{
    ...
    public class PictureValidCode
    {
        ...
        /// </summary>
        /// <param name="Length">Length.</param>
		public PictureValidCode(int Length)
        {
            HttpContext.Current.Response.Expires = 0;
            HttpContext.Current.Response.Buffer = true;
            HttpContext.Current.Response.ExpiresAbsolute = DateTime.Now.AddSeconds(-1);
            ...
            HttpContext.Current.Response.CacheControl = "no-cache";
            LetterCount = Length;
            Text = ValidCode.Number(LetterCount);
            CreateImage();
        }
		...
		public PictureValidCode(int Length, int type)
        {
            HttpContext.Current.Response.Expires = 0;
            HttpContext.Current.Response.Buffer = true;
            HttpContext.Current.Response.ExpiresAbsolute = DateTime.Now.AddSeconds(-1);
        ...
        private void InitText()
        {
            switch (Type)
            {
                case 0: Text = ValidCode.Number(LetterCount); break;
                case 1: Text = ValidCode.Char(LetterCount); break;
                case 2: Text = ValidCode.Mixed(LetterCount); break;
                default:
