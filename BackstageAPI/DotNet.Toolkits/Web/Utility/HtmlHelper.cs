...
namespace Toolkits.Web
{
    public class HtmlHelper
    {
        ...
        #region HttpWebRequest 方式获取HTML,可选择编码类型

        /// <summary>
        /// HttpWebRequest 方式获取HTML,可选择编码类型
        /// </summary>
        /// <param name="url"></param>
        /// <param name="en"></param>
        /// <returns></returns>
        public static string GetHtmlSource(string url, Encoding en)
        {
            //处理内容
            string html = "";
            ...
            System.IO.StreamReader reader = new System.IO.StreamReader(stream, en);
        ...
        #endregion HttpWebRequest 方式获取HTML,可选择编码类型

        #region 获取指定标签

        public static string GetNodeByTag(string html, string tag)
        {
            return "";
        }
